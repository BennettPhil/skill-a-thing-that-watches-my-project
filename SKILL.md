---
name: a-thing-that-watches-my-project
description: a thing that watches my project for TODO and FIXME comments and makes a summary. ideally grouped by file an...
version: 0.1.0
license: Apache-2.0
---

# Purpose
Implement the idea: a thing that watches my project for TODO and FIXME comments and makes a summary. ideally grouped by file and maybe with a priority if i put like TODO(high) or whatever
